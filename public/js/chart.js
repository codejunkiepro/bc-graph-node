 ...
 */
    ...
    function Ne(t, e, i, o, a, r = {}) {
        ...
        for (t.save(),
            ...
            c = 0; c < l.length; ++c)
            d = l[c],
                r.backdrop && fill_Rect(t, r.backdrop),
    ...
    function Tn() {
        return u(ChartClass.instances, (t => t._plugins.invalidate()))
    }
    function Ln() {
    ...
    return ChartClass.register(Yn, jo, fo, t),
        ChartClass.helpers = {
            ...Wi
        },
        ChartClass._adapters = Rn,
        ChartClass.Animation = Cs,
        ChartClass.Animations = Os,
        ChartClass.animator = xt,
        ChartClass.controllers = en.controllers.items,
        ChartClass.DatasetController = Ns,
        ChartClass.Element = Hs,
        ChartClass.elements = fo,
        ChartClass.Interaction = Xi,
        ChartClass.layouts = as,
        ChartClass.platforms = Ss,
        ChartClass.Scale = Js,
        ChartClass.Ticks = ae,
        Object.assign(ChartClass, Yn, jo, fo, t, Ss),
        ChartClass.Chart = ChartClass,
        "undefined" != typeof window && (window.Chart = ChartClass),
        ChartClass
}
));
